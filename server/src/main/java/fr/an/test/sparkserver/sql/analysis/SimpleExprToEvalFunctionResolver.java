...
import fr.an.test.sparkserver.sql.eval.EvalCtx;
import fr.an.test.sparkserver.sql.expr.SimpleBinaryOperator;
import fr.an.test.sparkserver.sql.expr.SimpleBinaryOperators;
import fr.an.test.sparkserver.sql.expr.SimpleExpr;
import fr.an.test.sparkserver.sql.expr.SimpleExprVisitor2;
import lombok.val;
