...
export class SalesRestService {
    ...
    /**
     * list first N(default&#x3D;20) sales
     * 
     * @param limit 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public first(limit?: number, observe?: 'body', reportProgress?: boolean): Observable<Array<SalesDTO>>;
    public first(limit?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<SalesDTO>>>;
    public first(limit?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<SalesDTO>>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public list(observe?: 'body', reportProgress?: boolean): Observable<Array<SalesDTO>>;
    public list(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<SalesDTO>>>;
    public list(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<SalesDTO>>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public query(body: QueryRequestDTO, observe?: 'body', reportProgress?: boolean): Observable<Array<RowDTO>>;
    public query(body: QueryRequestDTO, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<RowDTO>>>;
    public query(body: QueryRequestDTO, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<RowDTO>>>;
    public query(body: QueryRequestDTO, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
